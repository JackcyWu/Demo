...
<HTML>
	...
	<body>
	<s:form id="userAction_save_do" name="Form1" theme="simple" action="userAction_doUpdate" method="post" enctype="multipart/form-data">	
		&nbsp;
		<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff" colspan="3">
				    <s:textfield name="logonName" value="%{model.logonName}" id="userAction_save_do_logonName" cssClass="bg"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff">
					 <s:select list="{'博士','硕士','研究生','本科','专科','高中'}" value="%{model.education}" headerKey="" headerValue="--选择学历--" name="education" id="education"></s:select>
				</td>
			</tr>
			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff" colSpan="3">
					 <s:checkboxlist list="{'看电影','旅游','健身','购物','睡觉'}" value="%{model.interest.split(', ')}" name="interest"></s:checkboxlist>
				</td>
			</tr>
			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01">
				...
				<td class="ta_01" bgColor="#ffffff" colSpan="3">
					<s:file name="upload" size="30" value="%{model.upload}" id="userAction_save_do_upload"/>
				</td>
			</tr>
			<TR>
				...
				<TD class="ta_01" bgColor="#ffffff" colSpan="3">
				    <s:textarea name="remark" value="%{model.remark}" cols="30" rows="3" id="userAction_save_do_remark" cssStyle="WIDTH: 96%" />
				</TD>
			</TR>
			<TR>
